 ...
 */
/* package */
class DashVodRendererBuilder implements PlayerActivity.RendererBuilder,
  ...
  private PlayerActivity.RendererBuilderCallback callback;

  public DashVodRendererBuilder(PlayerActivity playerActivity, String userAgent, String url,
      String contentId) {
  ...
  @Override
  public void buildRenderers(PlayerActivity.RendererBuilderCallback callback) {
