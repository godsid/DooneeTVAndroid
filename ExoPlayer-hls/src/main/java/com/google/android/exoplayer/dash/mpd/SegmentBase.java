...
public abstract class SegmentBase {
  ...
  /**
   * A {@link com.google.android.exoplayer.dash.mpd.SegmentBase} that defines a single segment.
   */
  ...
  /**
   * A {@link com.google.android.exoplayer.dash.mpd.SegmentBase} that consists of multiple segments.
   */
  ...
  /**
   * A {@link com.google.android.exoplayer.dash.mpd.SegmentBase.MultiSegmentBase} that uses a SegmentList to define its segments.
   */
  ...
  /**
   * A {@link com.google.android.exoplayer.dash.mpd.SegmentBase.MultiSegmentBase} that uses a SegmentTemplate to define its segments.
   */
