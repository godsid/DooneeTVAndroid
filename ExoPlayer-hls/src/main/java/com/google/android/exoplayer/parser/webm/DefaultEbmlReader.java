...
/* package */ final class DefaultEbmlReader implements EbmlReader {
  ...
  /**
   * Reads a set amount of bytes into a {@link java.nio.ByteBuffer} such that reading can be stopped
   ...
   * @param byteBuffer The {@link java.nio.ByteBuffer} into which bytes should be read
