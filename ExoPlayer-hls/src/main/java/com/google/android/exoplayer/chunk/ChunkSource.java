...
public interface ChunkSource {
  ...
  /**
   * Adaptive video {@link com.google.android.exoplayer.chunk.ChunkSource} implementations must set the maximum video dimensions on
   ...
   *     initially equal to null or a {@link Chunk} previously supplied by the {@link com.google.android.exoplayer.chunk.ChunkSource}
  ...
  /**
   * If the {@link com.google.android.exoplayer.chunk.ChunkSource} is currently unable to provide chunks through
   * {@link com.google.android.exoplayer.chunk.ChunkSource#getChunkOperation}, then this method returns the underlying cause. Returns
   * null otherwise.
   *
   * @return An {@link java.io.IOException}, or null.
   */
