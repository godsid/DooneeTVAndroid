...
public final class DataSpec {
  ...
  /**
   * A permitted value of {@link #length}. A {@link com.google.android.exoplayer.upstream.DataSpec} defined with this length represents
   ...
   * {@link com.google.android.exoplayer.upstream.DataSpec} is not intended to be used in conjunction with a cache.
   */
  public final String key;

  /**
   * Construct a {@link com.google.android.exoplayer.upstream.DataSpec} for which {@link #uriIsFullStream} is true.
   *
   * @param uri {@link #uri}.
  ...
  /**
   * Construct a {@link com.google.android.exoplayer.upstream.DataSpec} for which {@link #uriIsFullStream} is false.
   *
   * @param uri {@link #uri}.
