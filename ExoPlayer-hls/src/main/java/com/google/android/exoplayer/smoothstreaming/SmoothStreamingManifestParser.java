...
public class SmoothStreamingManifestParser {
  ...
  /**
   * Parses a manifest from the provided {@link java.io.InputStream}.
   *
   * @param inputStream The stream from which to parse the manifest.
   * @param inputEncoding The encoding of the input.
   * @return The parsed manifest.
   * @throws java.io.IOException If a problem occurred reading from the stream.
  ...
  private static abstract class ElementParser {
    ...
    /**
     * Whether this {@link com.google.android.exoplayer.smoothstreaming.SmoothStreamingManifestParser.ElementParser} parses a child element inline.
     *
