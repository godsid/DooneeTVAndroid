...
public abstract class Chunk implements Loadable {
  ...
  /**
   * Initializes the {@link com.google.android.exoplayer.chunk.Chunk}.
   *
  ...
  /**
   * Releases the {@link com.google.android.exoplayer.chunk.Chunk}, releasing any backing buffers.
   */
   ...
   *
   * @throws java.io.IOException If an error occurs consuming the loaded data.
   */
