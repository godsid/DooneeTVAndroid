...
/**
 * Manages the background loading of {@link com.google.android.exoplayer.upstream.Loader.Loadable}s.
 */
public final class Loader {
  ...
  /**
   * Interface definition of an object that can be loaded using a {@link com.google.android.exoplayer.upstream.Loader}.
   */
  ...
  /**
   * Interface definition for a callback to be notified of {@link com.google.android.exoplayer.upstream.Loader} events.
   */
  ...
  /**
   * Start loading a {@link com.google.android.exoplayer.upstream.Loader.Loadable}.
   * <p>
   * A {@link com.google.android.exoplayer.upstream.Loader} instance can only load one {@link com.google.android.exoplayer.upstream.Loader.Loadable} at a time, and so this method
   * must not be called when another load is in progress.
   *
   * @param loadable The {@link com.google.android.exoplayer.upstream.Loader.Loadable} to load.
   */
  ...
  /**
   * Whether the {@link com.google.android.exoplayer.upstream.Loader} is currently loading a {@link com.google.android.exoplayer.upstream.Loader.Loadable}.
   *
   * @return Whether the {@link com.google.android.exoplayer.upstream.Loader} is currently loading a {@link com.google.android.exoplayer.upstream.Loader.Loadable}.
   */
  ...
  /**
   * Releases the {@link com.google.android.exoplayer.upstream.Loader}.
   * <p>
   * This method should be called when the {@link com.google.android.exoplayer.upstream.Loader} is no longer required.
   */
  public void release() {
    if (loading) {
      cancelLoading();
