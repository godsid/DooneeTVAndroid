 ...
 * Rather than implementing the loading and rendering of media directly, {@link com.google.android.exoplayer.ExoPlayer} instead
 * delegates this work to one or more {@link TrackRenderer}s, which are injected when the player
 * is prepared. Hence {@link com.google.android.exoplayer.ExoPlayer} is capable of loading and playing any media for which a
 ...
 *
 * <p>The figure below shows the {@link com.google.android.exoplayer.ExoPlayer} threading model.</p>
 ...
 * </li>
 * <li>Registered {@link com.google.android.exoplayer.ExoPlayer.Listener}s are invoked on the thread that created the {@link com.google.android.exoplayer.ExoPlayer}
 * instance.</li>
 ...
 * <h3>Player state</h3>
 *
 * <p>The components of an {@link com.google.android.exoplayer.ExoPlayer}'s state can be divided into two distinct groups. State
...
public interface ExoPlayer {
  ...
  public static final class Factory {
    ...
    /**
     * Obtains an {@link com.google.android.exoplayer.ExoPlayer} instance.
     * <p>
  ...
  public interface Listener {
    /**
     * Invoked when the value returned from either {@link com.google.android.exoplayer.ExoPlayer#getPlayWhenReady()} or
     * {@link com.google.android.exoplayer.ExoPlayer#getPlaybackState()} changes.
     *
    ...
    /**
     * Invoked when the current value of {@link com.google.android.exoplayer.ExoPlayer#getPlayWhenReady()} has been reflected
     * by the internal playback thread.
     * <p>
     * An invocation of this method will shortly follow any call to
     * {@link com.google.android.exoplayer.ExoPlayer#setPlayWhenReady(boolean)} that changes the state. If multiple calls are
     ...
     * {@link com.google.android.exoplayer.ExoPlayer#STATE_IDLE} immediately after this method is invoked. The player instance
     * can still be used, and {@link com.google.android.exoplayer.ExoPlayer#release()} must still be called on the player should
  ...
  /**
   * A component of an {@link com.google.android.exoplayer.ExoPlayer} that can receive messages on the playback thread.
   * <p>
   * Messages can be delivered to a component via {@link com.google.android.exoplayer.ExoPlayer#sendMessage} and
   * {@link com.google.android.exoplayer.ExoPlayer#blockingSendMessage}.
   */
   ...
   *     value that was passed to the {@link com.google.android.exoplayer.ExoPlayer.Factory#newInstance} method.
   */
  ...
  /**
   * Whether the current value of {@link com.google.android.exoplayer.ExoPlayer#getPlayWhenReady()} has been reflected by the
   ...
   * {@link com.google.android.exoplayer.ExoPlayer#STATE_IDLE}. Note that the player instance can still be used, and that
   * {@link com.google.android.exoplayer.ExoPlayer#release()} must still be called on the player should it no longer be required.
   * <p>
  ...
  /**
   * Blocking variant of {@link #sendMessage(com.google.android.exoplayer.ExoPlayer.ExoPlayerComponent, int, Object)} that does not return
   ...
   *
   * @return The duration of the track in milliseconds, or {@link com.google.android.exoplayer.ExoPlayer#UNKNOWN_TIME} if the
   ...
   *     or {@link com.google.android.exoplayer.ExoPlayer#UNKNOWN_TIME} if no estimate is available.
   */
